...
sandbox-run-agent-llm-local:
	$(MAKE) sandbox-run-agent AGENT_RUNTIME_MODE=llm LLM_BASE_URL=http://127.0.0.1:1234/v1 LLM_API_KEY=lm-studio LLM_MODEL=openai/qwen3.5-2b NO_PROXY=localhost,127.0.0.1
